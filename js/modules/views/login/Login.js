define(function (require, exports, module) {
  ...
  var loginUrl = browser.isIPhone || config.nakeServer ? '/api/login' : 'http://bbs.ngacn.cc/nuke.php?func=login';
  var gsUrl = browser.isIPhone || config.nakeServer ? '/api/gs' : 'http://bbs.ngacn.cc/nuke.php?func=login&normal_login&gs&raw=2';
